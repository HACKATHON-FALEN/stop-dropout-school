...
import FileExplorerChonky from "../../FileExplorer/FileExplorerChonky";
...
export default function ProfileDirector() {
  ...
  const editorText = "This is the initial context for the chat."; // Replace with actual editor text if dynamic
                ...
                <div className="flex flex-wrap justify-center">
                  ...
                  <div className="w-full lg:w-4/12 px-4 lg:order-3 lg:text-right lg:self-center">
                    <div className="py-6 px-3 mt-32 sm:mt-0">
                      ...
                      >
                        Explorează fișierele comune
                      </button>
                    </div>
                  </div>

                  {/* Component 2 - Chat */}
                  <Chat isOpen={isChatOpen} toggleChat={toggleChat} editorText={editorText} />


                  {/* Modal containing the FileExplorerChonky component */}
                  <Dialog
                    open={isModalOpen}
                    onClose={toggleModal}
                    maxWidth={false} // Set maxWidth to false to allow custom width
                    fullWidth={true}
                    PaperProps={{
                      style: {
                        width: '80%', // Adjust this percentage or set a specific pixel value like '1200px' for more control
                      },
                    }}
                  >
                    <DialogTitle>Fișiere Împărțite</DialogTitle>
                    <DialogContent
                      style={{
                        width: '90%',  // Adjust the width here. You can set this to 90% of the screen or set a fixed width like '1200px'
                        height: '80vh',  // You can keep the height as is or adjust accordingly
                        overflow: 'auto',
                        display: 'flex',
